---
mode: agent
description: "Refine a raw idea into a validated design brief that /plan can consume"
---
Model tier: **opus** — invoke this prompt in an Opus session. Conversational reasoning, no sub-agents by default.

# Brainstorm a Design Brief

Refine a raw idea into a validated design brief: ${input:idea}

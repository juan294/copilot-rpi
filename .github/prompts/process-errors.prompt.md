---
mode: agent
description: "Process error screenshots from ~/Desktop/agent-errors/"
---
# Process Error Screenshots

You are processing new agent error patterns from screenshots that Juan has saved.

## Steps

1. List all image files in `~/Desktop/agent-errors/`
...
7. Push to remote
8. Delete ALL processed images from `~/Desktop/agent-errors/`

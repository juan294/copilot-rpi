---
mode: agent
description: "Process all overnight agent reports and the Dependabot PR queue -- discover, analyze, fix everything, commit, merge"
---
...
5. **Draft the action plan:**
   ...
   Group action items by report. Include ALL items -- fix everything (Rule #31). For each item: what to do, which files, expected outcome.
...
- **Fix everything (Rule #31).** Categorize findings by severity, but implement 100% of action items. No deferring. No "nothing urgent."

...
The user drops agent error screenshots into a local folder (default: `~/Desktop/agent-errors/`). When they say "process my error screenshots", use the `/process-errors` prompt or follow this flow:

1. List all images in the error screenshots folder
...
This is the standard flow — no need for the user to check if errors are already cataloged.

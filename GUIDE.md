...
The blueprint includes 40 operational rules learned from real sessions — including 6 Copilot-specific rules covering prompt file frontmatter, `${input:var}` syntax, instruction file globs, CLI auth, auto-compaction, and chatmode directories.
...
| Error patterns | `patterns/agent-errors.md` | 37 documented errors with symptoms and solutions |
| Operational rules | `patterns/quick-reference.md` | 40 rules to prevent known mistakes |
